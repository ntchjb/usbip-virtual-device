...
func (m *MockDeviceRegistrar) Close() error {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceRegistrarMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockDeviceRegistrar)(nil).Close))
}
